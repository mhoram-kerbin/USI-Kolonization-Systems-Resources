...
\begin{align*}
  e(X) & := \max\left(ce_K\left(\frac{\min\left(\max\left(\frac{1}{K}\left(2H_M+10H_O+\frac{C}{10}\right), 0.5\right), 1.5\right)\cdot \left(\frac{K - k}{2}+(2k-s)\right)\cdot \frac{2W+M+\frac{C}{4}}{K}}{R}\right)\right.\\
    & \left.+ b\left(\frac{ep(X)}{t(X)}-1\right), 0.25\right)
\end{align*}
